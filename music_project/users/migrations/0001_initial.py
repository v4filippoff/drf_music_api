    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=2000, null=True, verbose_name='User description')),
                ('country', models.CharField(blank=True, max_length=50, null=True, verbose_name='Country')),
                ('avatar', models.ImageField(blank=True, null=True, upload_to=users.services.get_avatar_upload_path, verbose_name='User avatar')),
